...
def pytest_files() -> list[str]:
    ...
    return [
        "src/dft_local/transport/boltzmann/test_conductivity_business_logic.py",
        ...
        "src/dft_local/transport/boltzmann/test_core.py",
        "src/dft_local/transport/boltzmann/test_diagnostics.py",
    ]
